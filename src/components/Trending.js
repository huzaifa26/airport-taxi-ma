        ...
        <div className="w-[calc(100vw - 100%)] mt-[30px]">
            <div className="xsm:hidden sm:hidden flex flex-col m-auto w-[87.13541666666667vw] min-h-[729px]">
                <div className="flex h-[140px]">
                    <h2 className="text-[#262626] text-[48px] font-[600] leading-[70px] xsm:leading-[36px] w-[533px]"><span className="text-[#F2B120]">Trending</span> Fleets Great & Fast <span className="text-[#006CB7]">This Week</span></h2>
                ...
                <div className="flex gap-[20px]">
                    ...
                    <div className="w-[19.791666666666668vw] min-w-[194.25px] h-[271px] rounded-[4px]">
                        ...
                        <div className="w-[18.32847222222222vw] min-w-[179.53px] m-auto relative top-[-60px] flex justify-around mt-[20px]">
                            <div>
                                <h3 className="text-[11.76px] leading-[178.5%] font-[500]">Compact Sedan</h3>
                            ...
                            <div className="flex flex-col items-center justify-center">
                                <h3 className="text-[clamp(12px,1.225vw,17.64px)] font-[600]">$250</h3>
                ...
                <div className="flex gap-[38px] relative left-[32%] top-[-62px]">
